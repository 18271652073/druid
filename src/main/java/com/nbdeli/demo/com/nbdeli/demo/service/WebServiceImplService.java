 ...
 * 
 */
@WebServiceClient(name = "WebServiceImplService", targetNamespace = "http://service.demo.nbdeli.com/", wsdlLocation = "http://10.168.97.207:8989/webservcie?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WEBSERVICEIMPLSERVICE_QNAME = new QName("http://service.demo.nbdeli.com/", "WebServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://10.168.97.207:8989/webservcie?wsdl");
    ...
    public WebServiceImpl getWebServiceImplPort() {
        return super.getPort(new QName("http://service.demo.nbdeli.com/", "WebServiceImplPort"), WebServiceImpl.class);
    }
    ...
    public WebServiceImpl getWebServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.demo.nbdeli.com/", "WebServiceImplPort"), WebServiceImpl.class, features);
    }
